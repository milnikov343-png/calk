...
DEFAULT_PRICES = {
    ...
    "Ворота откатные со швеллером балкой и роликами": 45500,
    "Ворота распашные стандарт": 19500,
    "Калитка стандарт": 9500,
    # --- Столбы (цена за м.п.) ---
    "Столб 60х60х2мм": 944,
    "Столб 73мм НКТ": 1042,
    "Столб 60х40х2мм": 772,
    ...
    # --- Монтаж ---
    "Монтаж ворот откатных": 32000,
    "Монтаж ворот распашных": 7500,
    "Монтаж калитки": 4500,
...
def calculate_fence(params, prices, proflist, shtaket):
    ...
    fence_length = params["fence_length"]  # общая длина забора (м.п.)
    ...
    has_kalitka = params["has_kalitka"]
    kalitka_count = params["kalitka_count"]
    has_otkatnye = params["has_otkatnye"]
    otkatnye_count = params["otkatnye_count"]
    has_raspashnye = params["has_raspashnye"]
    raspashnye_count = params["raspashnye_count"]
    ...
    # --- Количество столбов ---
    # Формула: (длина - калитки*1 - откатные*4 - распашные*4) / 3
    ...
    if fence_length < 30:
        ...
        price_montazh = 1000
    elif fence_length < 50:
        price_stolb_install = 450
        price_montazh = 900
    elif fence_length < 100:
    ...
    if has_fundament:
        ...
        if beton_m3 > 8:
            ...
            fund_work_price = 4900
        else:
            fund_work_unit = "м.п."
            fund_work_qty = fund_length
            fund_work_price = 1900
    ...
    if n_otkatnye > 0:
        works.append({
            ...
            "unit": "шт", "qty": n_otkatnye, "price": prices.get("Монтаж ворот откатных", 32000),
            "total": n_otkatnye * prices.get("Монтаж ворот откатных", 32000)
        })
    ...
    if n_raspashnye > 0:
        works.append({
            ...
            "unit": "шт", "qty": n_raspashnye, "price": prices.get("Монтаж ворот распашных", 7500),
            "total": n_raspashnye * prices.get("Монтаж ворот распашных", 7500)
        })
    ...
    if n_kalitka > 0:
        works.append({
            "name": "Монтаж калитки",
            "unit": "шт", "qty": n_kalitka, "price": prices.get("Монтаж калитки", 4500),
            "total": n_kalitka * prices.get("Монтаж калитки", 4500)
        })
    ...
    if n_otkatnye > 0:
        otk_price = prices.get("Ворота откатные со швеллером балкой и роликами", 45500)
        materials.append({
    ...
    if n_raspashnye > 0:
        rasp_price = prices.get("Ворота распашные стандарт", 19500)
        materials.append({
    ...
    # Калитка (материал)
    if n_kalitka > 0:
        kal_price = prices.get("Калитка стандарт", 9500)
        materials.append({
