...
# Вспомогательная функция для отрисовки рамки
...
# --- ПРОВЕРКА ФОРМЫ (ЗАГЛУШКА ДЛЯ СЛОЖНЫХ) ---
is_complex = (shape_type != "⬜ Прямоугольная (Стандарт)") or has_pool

if is_complex:
    st.warning("Интерфейс для сложных форм и бассейнов активирован.")
    st.info("💡 Инженерный модуль математического маскирования (расчет вырезов, округлых контуров, овальных бассейнов и свайного поля) находится в стадии интеграции. \n\nПока вы можете использовать левое меню для проверки удобства ввода данных. Для выполнения расчетов переключитесь на Прямоугольную форму без бассейна.")
    st.stop()
